...
<body>
    ...
    <section class="lamp" id="sectionLamp">
        ...
        <section class="dividir-em-dois">
            ...
            <ul class="menuProjeto" id="menuRedes-sociais">
                <article class="sectionIframe"><iframe src="https://profissional-marcelo.github.io/ProjetoRedesSociais/" frameborder="0"></iframe></article>
                <article class="container">
